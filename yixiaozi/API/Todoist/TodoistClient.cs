...
using yixiaozi.API.Todoist.Exceptions;
using yixiaozi.API.Todoist.Models;
using yixiaozi.API.Todoist.Serialization.Resolvers;
using yixiaozi.API.Todoist.Services;

namespace yixiaozi.API.Todoist
{
    /// <summary>
    /// A Todoist client.
    /// </summary>
    /// <seealso cref="System.IDisposable" />
    /// <seealso cref="yixiaozi.API.Todoist.IAdvancedTodoistClient" />
