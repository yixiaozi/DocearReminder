...
namespace yixiaozi.API.Todoist.Services
{
    ...
    /// </summary>
    /// <seealso cref="yixiaozi.API.Todoist.Services.ItemsCommandService" />
    /// <seealso cref="yixiaozi.API.Todoist.Services.IItemsService" />
    internal class ItemsService : ItemsCommandService, IItemsService
    {
        ...
        public Task<Item> QuickAddAsync(Label quickAddItem)
        {
            if (quickAddItem == null)
            {
                throw new ArgumentNullException(nameof(quickAddItem));
