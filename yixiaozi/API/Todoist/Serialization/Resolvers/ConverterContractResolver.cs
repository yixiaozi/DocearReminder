...
using yixiaozi.API.Todoist.Serialization.Converters;

namespace yixiaozi.API.Todoist.Serialization.Resolvers
{
    internal class ConverterContractResolver : DefaultContractResolver
    {
        ...
        protected override JsonProperty CreateProperty(MemberInfo member, MemberSerialization memberSerialization)
        {
            ...
            // https://developer.yixiaozi.API.Todoist.com/sync/v8/#due-dates
